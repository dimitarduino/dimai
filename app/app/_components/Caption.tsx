...
function Caption({ onCaptionChange, selectedCaption, classesCaption = ``, captionName = ``, activeCaptionProp = false } : CaptionProps) {
    ...
    return (
        <div className={`w-full p-4 cursor-pointer px-6 border border-gray-300 rounded-md flex justify-center items-center ${(selectedCaption == captionName) ? `bg-gray-200 dark:bg-zinc-700 border-primary border-2` : `hover:bg-gray-100 dark:hover:bg-zinc-800 bg-gray-100 dark:bg-zinc-900`}`} onClick={handleClick}>
