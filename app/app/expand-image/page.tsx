...
import { deductUserCredits, insertExpandedImage } from "@/app/app/_actions/dashboard-data";
...
export default function ImageToImage() {
    ...
    const generateImageFromStyle = async (imageUrl) => {
        ...
        const data = await axios.post("/api/expand-image", {
            imageUrl: imageUrl,
    ...
    return (
        <div className="w-full flex">
            <div className="flex bg-white dark:bg-zinc-900 py-12 rounded-xl shadow-sm px-10 mt-4 flex-col max-w-4xl mx-auto space-y-4 p-4">
                <h1 className="font-bold text-3xl text-primary">Expand Images with AI</h1>
                <h2>
                    Expand your images with AI-powered effects. Upload an image and watch it transform instantly.
                </h2>
